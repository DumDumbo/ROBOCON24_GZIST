...
class TargetLocked:
        ...
        def __init__(self):
                ...
                self.cameraMatrix = np.array([[570.3422047415297, 0.0, 319.5],
                                                                        [0.0, 570.3422047415297, 239.5],
        ...
        def posTransform2Base_link(self, x, y, z, frame_id):
                ...
                try:
                        ...
                        rospy.logwarn("Failed to transform target position to base_link frame, From target_locked.py line 81.")
                        self.posBaseLink = None
        ...
        def lockedCallback(self, targets_data):
                ...
                # 获取X轴像素坐标最接近320的坐标点
                self.nearestTarget = min(targets_data.positions, key=lambda position: abs(position.centerX-320))
