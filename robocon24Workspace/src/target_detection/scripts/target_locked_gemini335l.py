...
class TargetLocked:
        ...
        def __init__(self):
                ...
                self.cameraMatrix = np.array([[367.9948425292969, 0.0, 322.73687744140625],
                                            [0.0, 368.0999450683594, 233.8047637939453],
        ...
        def posTransform2Base_link(self, x, y, z, frame_id):
                ...
                try:
                        ...
                        rospy.logwarn("Failed to transform target position to base_link frame, From target_locked_gemini335l.py line 81.")
...
if __name__ == '__main__':
	# ros节点初始化
	rospy.init_node('target_locked_gemini335l.py')
