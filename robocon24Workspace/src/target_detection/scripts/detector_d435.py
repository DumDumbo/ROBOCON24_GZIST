...
class tragetDetection:
	...
	def __init__(self):
		...
		vertAngle = 0.37088246605               #RGB图垂直视场角
		horizontalAngle =  0.60213859194  	    #RGB图水平视场角
	...
	def getTarget(self, image_data, depth_data, box_data):
		...
		depthFrame = self.bridge.imgmsg_to_cv2(depth_data, desired_encoding='16UC1')#"16UC1")	
    ...
    *    	AverageDistance: 	对象的距离
	...
	def __analyseBox(self, centerX, centerY, depthFrame):
		...
		if(averageDistance>=150 and averageDistance<=4000):
