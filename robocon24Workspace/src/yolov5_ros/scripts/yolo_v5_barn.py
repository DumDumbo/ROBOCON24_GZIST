 ...
 *                  Publish:   1st:    '/yolov5/barn_image'(识别后图像) 
 *                                      2nd:   '/yolov5/barn_status'(话题的bounding_boxes列表存储着每个对象的物体框信息)
 *                      
 * @version: 1.0
 * 
...
class Yolo_Dect:
    def __init__(self):
        ...
        pub_topic = rospy.get_param('~pub_topic', '/barn_status')
        ...
        self.image_pub = rospy.Publisher(
            '/yolov5/barn_image',  Image, queue_size=1)
    ...
    def image_callback(self, image):
        ...
        if image.encoding == 'rgb8':
            ...
            rospy.logwarn("Please check image encoding, from yolo_v5_box.py line 105")
...
def main():
    rospy.init_node('yolo_v5_barn', anonymous=True)
    yolo_dect = Yolo_Dect()
    rospy.spin()
