...
class Yolo_Dect:
    def __init__(self):
        ...
        image_topic = rospy.get_param('~image_topic', '/OpencvImage')
        pub_topic = rospy.get_param('~pub_topic', '/add')
        ...
        self.image_pub = rospy.Publisher(
            '/yolov5/add_image',  Image, queue_size=1)
...
def main():
    rospy.init_node('yolov5_add', anonymous=True)
    yolo_dect = Yolo_Dect()
    rospy.spin()
