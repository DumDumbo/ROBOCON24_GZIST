// Generated by gencpp from file astra_camera/DeviceInfo.msg
// DO NOT EDIT!


#ifndef ASTRA_CAMERA_MESSAGE_DEVICEINFO_H
#define ASTRA_CAMERA_MESSAGE_DEVICEINFO_H
...
struct DeviceInfo_
{
  ...
  typedef boost::shared_ptr< ::astra_camera::DeviceInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::astra_camera::DeviceInfo_<ContainerAllocator> const> ConstPtr;

}; // struct DeviceInfo_

typedef ::astra_camera::DeviceInfo_<std::allocator<void> > DeviceInfo;

typedef boost::shared_ptr< ::astra_camera::DeviceInfo > DeviceInfoPtr;
typedef boost::shared_ptr< ::astra_camera::DeviceInfo const> DeviceInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::astra_camera::DeviceInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::astra_camera::DeviceInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::astra_camera::DeviceInfo_<ContainerAllocator1> & lhs, const ::astra_camera::DeviceInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::astra_camera::DeviceInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::astra_camera::DeviceInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::astra_camera::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::astra_camera::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::astra_camera::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::astra_camera::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::astra_camera::DeviceInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::astra_camera::DeviceInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf8aabac6d632dd26ULL;
  static const uint64_t static_value2 = 0x41eb4f5942464a66ULL;
};

template<class ContainerAllocator>
struct DataType< ::astra_camera::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::astra_camera::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::astra_camera::DeviceInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::astra_camera::DeviceInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::astra_camera::DeviceInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ASTRA_CAMERA_MESSAGE_DEVICEINFO_H
